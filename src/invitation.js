    ...
    if (showYesMessage && invitationData) {
        return (
            <div className="yes-message-container">
                ...
                {/* Ajoutez ici votre formulaire pour le type de nourriture */}
                <form>
                    <label htmlFor="foodType">Quel type de nourriture aimerais-tu manger ?</label>
                ...
                {showTitleAndQuestion && (
                    <>
                        ...
                        <p className="invitation-response__question">
                            Veux tu etre ma Valentine/Valentin ?
                        </p>
                        <em>Je sais que tu ne vas pas appuyer sur "non" !</em>
                    </>
                )}
{showRefusalMessage ? (
    <div className="refusal-message">
        <p>{invitationData.messageNon}</p> {}
    </div>
) : (
                    <>
